...
![image](https://github.com/user-attachments/assets/38edfe6b-6782-4de6-8e31-0aca8028ce16)

### Result:
Thus the Information retrieval using vector space model in python has been successfully implemented.
